          ...
          <div className="pt-2 mt-2">
            ...
            <div className="m-4 p-4">
              ...
              <p className="p-1">
                ...
                QMK is a superpower that lets me remap <em>any</em> physical button press
                to <em>any</em> letter, character, or even
              ...
              <p className="p-1">
                ...
                I can move a character that a normal QWERTY keyboard keeps under a pinkie &mdash;
            ...
            <div className="m-4 p-4">
              ...
              <p className="p-1">
                ...
                When I hold that key,
                QMK transforms <kbd>e</kbd>, <kbd>s</kbd>, <kbd>d</kbd>, <kbd>f</kbd>,
                and <kbd>i</kbd>, <kbd>j</kbd>, <kbd>k</kbd>, <kbd>l</kbd>{" "}
            ...
            <div className="m-4 p-4">
              ...
              <p className="p-1">
                ...
                If you&apos;re reading this on a wide monitor, you might find it easier to see it
