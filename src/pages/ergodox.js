  ...
  return (
    <SiteChrome>
      ...
      <p>
        ...
        <a href="https://qmk.fm/">QMK firmware</a>. QMK is a superpower that
        lets me remap <em>any</em> physical button press to <em>any</em> letter,
        character, or even{" "}
        <a href="https://me.micahrl.com/blog/hack-save-qmk-firmware-source-to-keyboard/">
      ...
      <p>
        ...
        <Link href="/story">my battle with RSI</Link>. To see details on this,
        take <Link href="/?guide=mrlGuide">the guided tour</Link>.
      </p>
      ...
      <p>
        ...
        <Link href="/?keyId=l-f-2-9">function layer</Link> on my board. When I
        hold that key, QMK transforms the number keys <kbd>1</kbd> through{" "}
        <kbd>0</kbd> to function keys <kbd>F1</kbd> through <kbd>F10</kbd> ,
        transforms other keys to controls for multimedia playback or screen
        brightness, and more. When I let go of the function layer key, the board
        snaps back to normal instantly.
      </p>
      <p>
        A more fun one is my <Link href="/?keyId=l-f-8-9">arrow layer</Link>.
        When I hold that key, QMK transforms <kbd>e</kbd>, <kbd>s</kbd>,{" "}
        <kbd>d</kbd>, <kbd>f</kbd>, and <kbd>i</kbd>, <kbd>j</kbd>, <kbd>k</kbd>
      ...
      <p>
        ...
        <a href="https://github.com/mrled/qmk_firmware/blob/master/keyboards/ergodox_ez/keymaps/mrled/keymap.c">
          here
        </a>
        ...
        <a href="https://raw.githubusercontent.com/mrled/qmk_firmware/master/keyboards/ergodox_ez/keymaps/mrled/keymap.c">
          in the raw
        </a>
        .)
      </p>
