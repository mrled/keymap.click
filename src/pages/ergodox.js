      ...
      <div className="pt-6 mt-6">
        <div className="m-4 p-4">
          ...
          <p className="p-1">
            ...
            ergonomics in mind and are entirely customizable. See the homepage
            of the open source ErgoDox project:{" "}
        ...
        <div className="m-4 p-4">
          ...
          <p className="p-1">
            ...
            QMK is a superpower that lets me remap <em>any</em> physical button
            press to <em>any</em> letter, character, or even{" "}
          ...
          <p className="p-1">
            ...
            , <kbd>backspace</kbd>, and more &mdash; to the cluster of keys
            under the thumbs on my ErgoDox. This has been very helpful in{" "}
            <IntraAppLink href="/story">my battle with RSI</IntraAppLink>. To
            see details on this, take{" "}
        ...
        <div className="m-4 p-4">
          ...
          <p className="p-1">
            ...
            like many laptops have &mdash; layers work like that. I have a
            similar{" "}
            <IntraAppLink href="/?keyId=l-f-2-9">function layer</IntraAppLink>{" "}
            on my board. When I hold that key, QMK transforms the number keys{" "}
            <kbd>1</kbd> through <kbd>0</kbd> to function keys <kbd>F1</kbd>{" "}
            through <kbd>F10</kbd> , transforms other keys to controls for
            multimedia playback or screen brightness, and more. When I let go of
            the function layer key, the board snaps back to normal instantly.
          </p>
          <p className="p-1">
            ...
            <kbd>k</kbd>, <kbd>l</kbd> into arrow keys, taking inspiration from{" "}
        ...
        <div className="m-4 p-4">
          ...
          <p className="p-1">
            ...
            stylesheets or on a small screen. If you&apos;re reading this on a
            wide monitor, you might find it easier to see it{" "}
