...
export default function About() {
  return (
    <SiteChrome>
      <h1>Colophon</h1>
      <p>Many thanks to those listed here.</p>
      <ul>
        <li>
        ...
        <li>
          ...
          <a href="https://www.ergodox.io">original ErgoDox</a>. I&apos;m not
          sure I would have been able to work for some weeks of 2019 without
          this keyboard. It&apos;s made a big difference. Thanks for making it.
        </li>
        <li>
        ...
        <li>
          ...
          <a href="https://commons.wikimedia.org/wiki/File:Looped_square_on_white_background.svg">
        ...
        <li>
          ...
          <a href="https://shkspr.mobi/blog/2020/05/better-keyboard-buttons-in-html/">
            The &lt;kbd&gt; element
          </a>
        </li>
        <li>
