        ...
        <div className="w-full ">
          <div className="pt-2 mt-2">
            ...
            <div className="m-4 p-4">
              ...
              <p className="p-1">
                The keyboard, an
                {" "}<IntraAppLink href="/ergodox">ErgoDox-EZ</IntraAppLink>,
            ...
            <div className="m-4 p-4">
              ...
              <p className="p-1">
                ...
                and it has a slight &ldquo;tenting&rdquo;,
                which keeps my hands in a more natural orientation
                with my thumbs slightly higher than my pinkies.
                Most importantly, it has allowed me to reduce the intense strain on my pinkies
                by moving commonly used keys out from under weak pinkies
                to under much stronger thumbs.
              </p>
              <p className="p-1">
                Take <IntraAppLink href="/?guide=mrlGuide">the guided tour</IntraAppLink>{" "}
                for specifics.
              </p>
            </div>
            ...
            <div className="m-4 p-4">
              ...
              <p className="p-1">
                I&apos;m building it{" "}
                <ExternalLink href="https://github.com/mrled/keymap.click">on GitHub</ExternalLink>.
