      ...
      steps: [
        {
          ...
          guideText: "As you can see, an arrow key, and it highlights other keys",
        },
        {
          key: "r-f-9-9",
          selection: volKeySelection,
          guideText: "Here are all the volume keys. Key references work well here, like [[l-t-1-3|<kbd>shift</kbd>]].",
        },
        {
          key: "l-t-5-1",
          selection: pageUpDownHomeEndSelection,
          guideText: "asdf pages",
        },
        {
          key: "l-f-1-7",
          selection: bracketKeySelection,
          guideText: "asdf brackets",
        },
      ],
    },
    otherExample: {
