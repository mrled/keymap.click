...
export const leftHandKeys = [
  ...
  // top alpha row
  {
    ...
    startPos: [1, 3],
    info:
      "Slightly different from the [[l-f-1-1|location]] of this key on a normal keyboard, but more convenient than the [[l-f-2-9|ErgoDox default]]. You could theoretically swap it with the [[l-f-1-1|= key]], but I decided I preferred that this + key mirror the [[r-f-13-1|- key]] on opposite sides of the keyboard so I would remember them easier. That leaves this space as the best fit for this key. Additionally, while this is the location for the tab key on a normal keyboard, that key is much better suited for a non-pinky finger [[l-f-14-3|here]].",
  },
  {
    legend: "Q",
    board: ["left", "finger"],
