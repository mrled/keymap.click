...
export const leftHandKeys = [
  ...
  { legend: "5", board: ['left', 'finger'], startPos: [12, 1], info: normalLayoutInfo},
  {
    ...
    startPos: [14, 1],
    fontSize: "text-lg",
    info: "In my experience this is a MUCH better use of this key than the default layout of a left arrow. Reduces pinky strain compared to its default QWERTY position at [[l-f-1-1]]"
  },
