...
const pageUpDownHomeEndInfo =
  "An ok position for Page Up/Down and Home/End. Much better than the default Ergodox layout, which shifts these keys down by one, consuming the valuable [[l-t-5-5]] and [[r-t-1-5]] keys. You may or may not find these keys necessary - they tend to be heavily used on Windows (and also in VS Code), and much less useful on macOS. That said, with shift and space on opposite hands, Page Up is the only way you can scroll up one page with only one hand on the keyboard (while on a regular keyboard, shift+space will do this).";
const guiKeyInfo =
...
export const leftThumbKeys = [
  {
    ...
    startPos: [3, 1],
    info:
      "Some people will use this all the time; others might use ctrl-d instead and not need it much. Nice to at least have available for ctrl-alt-delete.",
  },
  {
    legend: "Home",
    legendText: "home",
