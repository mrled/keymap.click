...
export const leftHandKeys = [
  ...
  },
  {
    ...
    fontSize: "text-lg",
    info:
      "In my experience this is a MUCH better use of this key than the default layout of a left arrow. Reduces pinky strain compared to its default QWERTY position at [[l-f-1-1]]",
  },
  ...
  // middle / home alpha row
  {
    ...
    startPos: [1, 5],
    info:
      "I have nothing mapped here and I don't miss it. I guess you could put a real capslock key here if you want? On a normal keyboard, I remap capslock to ctrl, but that's not necessary on for this layout. Removing the ctrl mapping helped me remember the new ctrl location, which is why it's blank now.",
  },
  {
    legend: "A",
    board: ["left", "finger"],
  ...
  // the function row at the very bottom
  {
    ...
    startPos: [2, 9],
    info:
      "A tap/toggle key for the LAYER_FUNC layer, which contains F1-20 as well as keys like insert and pause/break.",
  },
  {
    legend: "⎆m",
    ...
    startPos: [4, 9],
    info:
      "A tap/toggle key for the LAYER_MEDIA layer, which contains keys like play/pause, skip track, and volume up/down/mute.",
  },
  {
    legend: "⎆c",
    ...
    startPos: [6, 9],
    info:
      "A tap/toggle key for the LAYER_COLOR layer, which changes the color of the underglow light. This layer is hardly a necessity and I rarely use it.",
  },
  {
    legend: "←",
...
export const leftThumbKeys = [
  {
    ...
    startPos: [3, 1],
    info:
      "Undecided what I'll do here long term. Currently space cadet shift, but it isn't a good place for a shift key and I don't see much benefit over the normal location for () over 8/9.",
  },
  {
    legend: "PgUp",
    legendText: "page up",
  ...
  },
  {
    ...
    fontSize: "text-xl",
    info:
      "I've found this to be a really good place for shift. I can easily reach any key necessary - the longest reach is to the = key for +, and I can do that easily, repeatedly, painlessly, and with room to spare. I did have to remap the normal shift key location (next to Z and ?) in order to train my hands to use this one, but after a day or two of that it feels very fast and natural.",
  },
  {
    legend: "⌫",
    ...
    fontSize: "text-xl",
    info:
      "The default ErgoDox-EZ location for backspace. Works great, and having this super commonly used key under a strong thumb is a huge improvement over having it under a weak pinky finger.",
  },
  {
    legend: "PgDn",
...
export const rightHandKeys = [
  ...
  // top alpha row
  {
    ...
    startPos: [1, 3],
    info:
      'Tap/Toggle key for my mouse / "pointer" layer. I don\'t use this all the time, BUT when my right arm is feeling particularly in pain or strained, it can be nice not to have to reach further to the right for the mouse.',
  },
  {
    legend: "Y",
    board: ["right", "finger"],
  ...
  },
  {
    ...
    startPos: [9, 9],
    info:
      "A tap/toggle key for the LAYER_TEST layer, which I can use for testing out layout changes to my main layer without changing the actual main layer I have gotten used to. I used this a lot at first, and then much less often as I got a layer I was more comfortable with, and bought a macropad for testing dances and other more advanced QMK functionality.",
  },
  {
    unset: true,
    board: ["right", "finger"],
    startPos: [11, 9],
    info:
      "I have room for more layers here, but I haven't needed any more yet.",
  },
  {
    unset: true,
    board: ["right", "finger"],
...
export const rightThumbKeys = [
  ...
  },
  {
    ...
    startPos: [5, 3],
    info:
      "A great place for the space key. I initially had mirrored space keys, one under each thumb, but eventually moved the left thumb to be shift, which was immediately a huge positive for me. That left the right thumb for space.",
  },
  {
    legend: "⌥",
    legendText: "option",
