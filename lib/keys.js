...
export const leftHandKeys = [
  ...
  },
  {
    legendSymbol: "⇥",
    legendText: "Tab",
    legendImageName: "icomoon/tab.svg",
    name: "tab",
    board: ["left", "finger"],
    size: [2, 3],
    startPos: [14, 3],
  ...
  },
  {
    legendSymbol: "⌘",
    legendText: "Gui",
    legendImageName: "icomoon/command.svg",
    name: "GUI",
    board: ["left", "finger"],
    size: [2, 3],
    startPos: [14, 6],
  ...
  {
    legendText: "Func",
    legendImageName: "icomoon/stack.svg",
    name: "function layer",
    board: ["left", "finger"],
    startPos: [2, 9],
    info:
  ...
  {
    legendText: "←",
    legendImageName: "icomoon/arrow-left2.svg",
    name: "left arrow",
    board: ["left", "finger"],
    startPos: [8, 9],
    info: arrowKeyInfo,
  ...
  {
    legendText: "→",
    legendImageName: "icomoon/arrow-right2.svg",
    name: "right arrow",
    board: ["left", "finger"],
    startPos: [10, 9],
    info: arrowKeyInfo,
...
export const leftThumbKeys = [
  ...
  },
  {
    legendSymbol: "⇧",
    legendText: "Shft",
    legendImageName: "icomoon/shift.svg",
    name: "shift",
    board: ["left", "thumb"],
    size: [2, 4],
    startPos: [1, 3],
  ...
  },
  {
    legendText: "Ctrl",
    legendSymbol: "⌃",
    legendImageName: "icomoon/ctrl.svg",
    name: "control",
...
export const rightHandKeys = [
  ...
  // the function row at the very bottom
  {
    legendText: "↑",
    name: "up arrow",
    legendImageName: "icomoon/arrow-up2.svg",
    board: ["right", "finger"],
    size: [2, 2],
    startPos: [5, 9],
    info: arrowKeyInfo,
  ...
  {
    legendText: "↓",
    legendImageName: "icomoon/arrow-down2.svg",
    name: "down arrow",
    board: ["right", "finger"],
    startPos: [7, 9],
    info: arrowKeyInfo,
  ...
  {
    legendText: "VOL-",
    legendImageName: "icomoon/volume-decrease.svg",
  ...
  {
    legendText: "VOL+",
    legendImageName: "icomoon/volume-increase.svg",
  ...
  {
    legendText: "VOL0",
    legendImageName: "icomoon/volume-mute2.svg",
...
export const rightThumbKeys = [
  ...
  },
  {
    legendSymbol: "⌥",
    legendText: "Opt",
    legendImageName: "icomoon/opt.svg",
    name: "option",
    board: ["right", "thumb"],
    legendSymbolFontSize: "text-sm md:text-base",
    size: [2, 2],
